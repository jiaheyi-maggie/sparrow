        ...
        pages={[
            {
                ...
                subtitle: <Text style={styles.subtitle}> Congrats on taking the fist step to managing your money efficiently! Let us get to know your spending habits with some basic questions :))</Text>,
            },
            {
                backgroundColor: '#fff',
                image: <Image 
                ...
                title: <Text adjustFontSizeToFit minimumFontScale={.5} 
                        style={styles.title}> Mark Categories </Text>,
                subtitle: <Text style={styles.subtitle}>This does not have to be perfect, just an estimate!</Text>,
            },
            {
                backgroundColor: '#fff',
                image: <Image 
                ...
                />,
                title: <Text style={styles.title}> Do you have a long-term budget? </Text>,
                subtitle: <Text style={styles.subtitle}> This way we can start by suggesting a budget that works for you. </Text>,
            },
        ]}
        />
    );
