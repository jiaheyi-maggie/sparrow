...
const NewPicker = ({ period }) => {
    ...
    // action to update newCategory's period
    const updateNewCategoryPeriod = (period) => {
        return (
            {
                type: "updateNewCategoryPeriod",
                payload: period
            }
        );
    };
                        ...
                        renderItem={({ item }) => (
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    ...
                                    store.dispatch(updateNewCategoryPeriod(chosen));
                                }}
                            >
